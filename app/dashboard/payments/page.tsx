  ...
  return (
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">결제 관리</h1>
          <p className="text-gray-400 mt-2">EOEO all sns payments 현황을 관리합니다</p>
        </div>
        <Button>
