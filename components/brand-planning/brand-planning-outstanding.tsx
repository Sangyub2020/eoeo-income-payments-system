...
interface BrandPlanningOutstandingProps {
  onSuccess?: () => void;
}

export function BrandPlanningOutstanding({ onSuccess }: BrandPlanningOutstandingProps) {
  ...
  const fetchRecords = async () => {
    try {
      ...
      if (data.success) {
        ...
        const outstandingRecords = allRecords.filter((record: BrandPlanningTeam) => {
