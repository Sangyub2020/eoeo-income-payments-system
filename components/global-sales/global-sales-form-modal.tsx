...
interface GlobalSalesFormModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}

export function GlobalSalesFormModal({ isOpen, onClose, onSuccess }: GlobalSalesFormModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 overflow-y-auto p-4">
      <div className="bg-slate-800/95 backdrop-blur-xl rounded-lg shadow-xl w-full max-w-6xl my-8 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-slate-800/95 backdrop-blur-xl border-b p-6 flex items-center justify-between z-10">
