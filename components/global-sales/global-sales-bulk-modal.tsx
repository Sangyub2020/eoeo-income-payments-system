...
export function GlobalSalesBulkModal({ isOpen, onClose, onSuccess }: GlobalSalesBulkModalProps) {
  ...
  const handleDownloadExample = () => {
    ...
    // 9:계약서링크, 10:견적서링크, 11:인보이스링크, 12:귀속연월
    // 13:선/잔금, 14:비율, 15:입금예정일, 16:실비금액
    // 17:입금예정금액, 18:입금예정통화, 19:적요, 20:입금일, 21:입금액
    // 22:입금통화, 23:작성일자, 24:세금계산서사본, 25:ISSUE사항, 26:과/면세/영세
    // 27:세금계산서발행공급가, 28:브랜드명(쉼표구분), 29:프로젝트유형2(생략가능)
    // 30:프로젝트유형3(생략가능), 31:프로젝트코드2(생략가능), 32:프로젝트코드3(생략가능)
    // 33:세금계산서첨부상태, 34:입금여부
    // 정확한 35개 컬럼 순서로 예시 데이터 생성
    const exampleData = `구분,거래처코드,회사명,사업자등록번호,인보이스이메일,프로젝트코드,프로젝트유형,프로젝트명,EOEO담당자,계약서링크,견적서링크,인보이스링크,귀속연월,선/잔금,비율,입금예정일,실비금액,입금예정금액,입금예정통화,적요,입금일,입금액,입금통화,작성일자,세금계산서사본,ISSUE사항,과/면세/영세,세금계산서발행공급가,브랜드명(쉼표구분),프로젝트유형2(생략가능),프로젝트유형3(생략가능),프로젝트코드2(생략가능),프로젝트코드3(생략가능),세금계산서첨부상태,입금여부
ONE-TIME,V001,ABC코스메틱(주),123-45-67890,invoice@abccos.com,P001,마케팅,신제품 런칭 프로젝트,홍길동,https://example.com/contract1,https://example.com/estimate1,https://example.com/invoice1,2512,일시불,100,2025-12-31,0,"₩5,000,000",KRW,신제품 런칭 마케팅 비용,2025-12-15,"₩5,000,000",KRW,2025-01-15,,,과세,"₩4,545,455","COLORGRAM,BRING GREEN",생략가능,생략가능,P002,P003,completed,입금완료
B2B,V002,XYZ트레이딩,987-65-43210,billing@xyztrade.com,P002,수출,미국 시장 진출,김철수,https://example.com/contract2,,https://example.com/invoice2,2511,선금,50,2025-11-30,0,"$10,000",USD,미국 시장 진출 프로젝트,2025-11-20,"$10,000",USD,2025-01-20,,,과세,"$9,090","WAKE MAKE,BRING GREEN,BIOHEAL BOH",생략가능,생략가능,생략가능,P004,required,입금예정`;
